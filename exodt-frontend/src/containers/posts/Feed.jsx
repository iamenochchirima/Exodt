...
import {Avatar, Card, CardActions, CardContent, CardHeader, CardMedia, Checkbox, IconButton, Typography, Link
  } from "@mui/material";
...
const Feed = () => {
	...
	if (isLoading) {
		content = <Box flex={5} sx={{margin: [2, 0, 5],height: '100vh'}}><Spinner/></Box>
	}  else if (!posts || posts.length === 0){
		content =<Box flex={5} sx={{margin: [2, 0, 5], height: '100vh'}}>
									...
									<Card >
										...
										>
											<CardHeader
												...
												src={post.author_details.profile_image} 
