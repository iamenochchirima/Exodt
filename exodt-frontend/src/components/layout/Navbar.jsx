...
const Header = () => {
  ...
  const { data: userProfileDetails } = useGetUserProfileDetailsQuery(id, {
  ...
  const guestLinks = () => (
    <Fragment>
      <div>
        ...
        <Link to="/login" underline="none" color="textPrimary">
  ...
  const [mobileMoreVertAnchorEl, setMobileMoreVertAnchorEl] =
    React.useState(null);
    ...
    >
      <MenuItem onClick={handleMessageClick}>
        <IconButton aria-label="show number of new messages" color="inherit">
          <Badge
            badgeContent={userProfileDetails?.message_count}
            color="secondary"
          >
            <Mail />
          </Badge>
      ...
      <StyledToolbar>
        ...
        {isAuthenticated ? (
          <div className={classes.sectionDesktop}>
            <IconButton
              aria-label="show number of new mails"
              color="inherit"
