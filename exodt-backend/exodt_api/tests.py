...
class TestMessage(APITestCase):
    ...
    def setUp(self):
        ...
        payload = {
            ...
            "username": "sender",
            "password": "sender123",
            "email": "iamenoch@mail.com"
        }

        # sender
        self.sender = UserAccount.objects.create_user(**payload)
        UserProfile.objects.create(
            first_name="sender", last_name="sender", user=self.sender, bio="sender")
        ...
        # receiver
        self.receiver = UserAccount.objects.create_user(
